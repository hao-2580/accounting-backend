...
-- 初始账户数据
INSERT INTO account (name, type, balance, remark) VALUES
('招商银行对公账户', 'BANK',    128600.00, '招商银行对公活期账户'),
('现金',         'CASH',      5200.00, '公司现金'),
('支付宝',       'ALIPAY',   18900.00, '支付宝企业账户');

-- 初始收支记录
INSERT INTO transaction (type, amount, category, account_id, date, note) VALUES
...
('EXPENSE',  3500.00, '广告推广', 1, '2026-01-15', '推广费用');

-- 初始发票数据
INSERT INTO invoice (invoice_no, client_name, issue_date, due_date, status, tax_rate, remark) VALUES
